...
public class genericMovement {
	...
	public genericMovement(double sp, String nm)
	{
		name = nm;
		this.ThreeD = false;
		init();
	...
	public genericMovement(double sp, String nm, boolean dimension)
	{
		name = nm;
		this.ThreeD = dimension;
		init();
	...
	public point[] nextLocation()
	{
		...
		if (nloc.boundcheck (400, -400, 600,-1, 400, -400) && turn == 0 && pitch == 0)
		{
			count -= 2;
		}
		else{
	...
	protected boolean checkHeading()
	{
		...
		int i = 0;
		while (out && i < 100){
			out = nloc.boundcheck(400, -400, 200,-1, 400, -400);
